...
def get_db_connection():
    try:
        return mysql.connector.connect(
            ...
            password="Gowthami.520@LJ",  # Your MySQL password
            database="req_analysis_dashboard"  # Your database name
        )
...
def admin_login():
    if request.method == 'POST':
        ...
        # Use environment variable or secure configuration for password
        # NEVER hardcode passwords directly in the code
